...
class Ui_NewContactWidget(object):
    def setupUi(self, NewContactWidget):
        ...
        self.imageButtonWidget = QtWidgets.QWidget(NewContactWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.imageButtonWidget.sizePolicy().hasHeightForWidth())
        self.imageButtonWidget.setSizePolicy(sizePolicy)
        self.imageButtonWidget.setObjectName("imageButtonWidget")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.imageButtonWidget)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.setPhoto = QtWidgets.QPushButton(self.imageButtonWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.setPhoto.sizePolicy().hasHeightForWidth())
        self.setPhoto.setSizePolicy(sizePolicy)
        self.setPhoto.setObjectName("setPhoto")
        self.horizontalLayout_3.addWidget(self.setPhoto)
        self.resetPhoto = QtWidgets.QPushButton(self.imageButtonWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.resetPhoto.sizePolicy().hasHeightForWidth())
        self.resetPhoto.setSizePolicy(sizePolicy)
        self.resetPhoto.setObjectName("resetPhoto")
        self.horizontalLayout_3.addWidget(self.resetPhoto)
        self.verticalLayout.addWidget(self.imageButtonWidget)
    ...
    def retranslateUi(self, NewContactWidget):
        ...
        self.photo.setText(_translate("NewContactWidget", "<html><head/><body><p><br/></p></body></html>"))
        self.setPhoto.setText(_translate("NewContactWidget", "Set Photo"))
        self.resetPhoto.setText(_translate("NewContactWidget", "Reset Photo"))
        ...
        self.saveButton.setText(_translate("NewContactWidget", "Save Contact"))
